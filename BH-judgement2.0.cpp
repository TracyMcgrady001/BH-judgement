...
#define D 100//critical mass density//质量密度判据
...
particle_data *BH(particle_data *p,float x,int z,char *str)//p为进行操作的particle_data结构体的头指针，x为判定所用临界数密度，z为粒子数
{   
